...
namespace API.Controllers
{
    ...
    public class MessageController : BaseApiController
    {
        ...
        {
            var userrname = User.GetUsername();

            if (userrname == createMessageDto.RecipientUsername.ToLower())
                return BadRequest("You cannot send messsages to yourself");

            var sender = await _userRepository.GetUserByUsernameAsync(userrname);

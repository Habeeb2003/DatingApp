...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<IEnumerable<MessageDto>> GetMessagesThread(string currentUsername, string recipientUseername)
        {
            var messages = await _context.Messages
                .Where(m => m.Recipient.UserName == currentUsername && m.RecipientDeleted == false
                    && m.Sender.UserName == recipientUseername
                    || m.Recipient.UserName == recipientUseername
